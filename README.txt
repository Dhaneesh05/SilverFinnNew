...
- 3D Interactive Garage: A fully immersive 3D interface built with react-three-fiber. Mechanics can visually select and inspect specific vehicle zones (Engine, Undercarriage, Interior, etc.) dynamically.
